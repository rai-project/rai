...
- A lot of workload burden on system Admins who need to maintain those accounts and VMs. This is particularly problematic if
...
for different hardware and software systems in a user-friendly fashion - easy for both users and system adminstrators
